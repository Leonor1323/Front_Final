...
const Home = () => {
  ...
  <h1 className="inline p-8 bg-gradient-to-r from-indigo-200 via-fuchsia-400 to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
      GIGITA SHOP
    </h1>
    <Link
  ...
  <div className="flex-1 bg-white">
      <div className="py-16 sm:py-24 xl:mx-auto xl:max-w-7xl xl:px-8">
        <div className="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-0">
          <a href="#" className="hidden text-sm font-semibold text-indigo-600 hover:text-indigo-500 sm:blockd">
